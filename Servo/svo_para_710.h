...
#if (EPO_SLOT_IN == 1)
#define TI_HOLD                               MS_32/4    // MS_30/4
#define TRAY_IN_LEVEL1                  328/4       // stage 1 TrayIn Force
#define TRAY_IN_LEVEL2                  308/4
#define TRAY_IN_LEVEL3                  60/4
#else
#define TI_HOLD                         MS_100/4
#define TRAY_IN_LEVEL1                  204/4
#define TRAY_IN_LEVEL2                  268/4
#define TRAY_IN_LEVEL3                  204/4
#endif
...
//TRAY LEVEL (-512(pull) ~ 511(push))
#if (EPO_SLOT_IN == 1)
#define TO_HOLD                         MS_50/4 //MS_65         // Tray-out hold time
#define TRAY_OUT_LEVEL1                 328/4//288
#define TRAY_OUT_LEVEL2                 308/4//224
#define TRAY_OUT_LEVEL3                 48/4
#define TRAY_FULL_LEVEL                 320/4
#else
#define TO_HOLD                         MS_35/4 //MS_65         // Tray-out hold time
#define TRAY_OUT_LEVEL1                 268/4//288
#define TRAY_OUT_LEVEL2                 204/4//224
#define TRAY_OUT_LEVEL3                 50/4
#endif
...
#define DISC_8CM_TH                     10.0          // acceleration RPM/mS
#define NO_DISC_TH                      33.0          // acceleration RPM/mS
...
#define FOCUS_SEARCH_KF18               0x1F95        // Kf18 (RAM address 0x28)
...
#define F_IDEN_UP_T_BD                  106            // Time to move lens up for disc detection.
#define F_IDEN_DN_T_DVD                 89            // Time to move lens down for disc detection.
#define F_IDEN_UP_T_DVD                 162           // Time to move lens up for disc detection.
#define F_IDEN_DN_T_CD                  99            // Time to move lens down for disc detection.
#define F_IDEN_UP_T_CD                  179           // Time to move lens up for disc detection.
#define F_IDEN_SENSITIVITY_BD       20000  //  (3300 / 1024 * 12 * 0.22 * 2200 / 0.41 * 0.52) // unit:nm/dac
#define F_IDEN_SENSITIVITY_HD           (3300 / 1024 * 12 * 0.22 * 2200 / 0.54 * 0.87) // unit:nm/dac
#define F_IDEN_SENSITIVITY_DVD      19355  //  (3300 / 1024 * 12 * 0.22 * 2200 / 0.56 * 0.87) // unit:nm/dac
#define F_IDEN_SENSITIVITY_CD        20689//   (3300 / 1024 * 12 * 0.22 * 2200 / 0.60 * 0.9) // unit:nm/dac
...
#if DDisc ==1
#if(CEProduct == 1)
#define DualDisc_STM_DVDLD_TH           700
#else
...
#define FGA_PHASE_CDROM                 (5)
#define FGA_PHASE_CDR                   (10)
#define FGA_PHASE_CDRW                  (10)
...
#define TGA_PHASE_CDROM                 (10)
#define TGA_PHASE_CDR                   (12)
#define TGA_PHASE_CDRW                  (16)
...
#if (SUPPORT_DPD == 1)
#define TRACKING_FACTOR_CD_DPD          128
#endif
#if (CD_MB_ONLY_OPU == 1)
...
#define SLED_DZ                         25            // unit:sled output dac. To compansate drive IC dead zone, set 0 to disable this function.
...
#if (SUN_FUNC_TEST == 1)
#define SLED_SAFE_JUMP_PROFILE { 10, 3, 3, 24, SLED_JUMP_GAIN} 
#define SLED_NORMAL_JUMP_PROFILE { 30, 9, 9, 60, SLED_JUMP_GAIN} 
#else
