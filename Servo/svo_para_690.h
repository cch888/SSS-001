...
*
*
* FILENAME:   svo_para_690.H
*
* DESCRIPTION: Servo Parameters for the SUN690 Project
*
*   $Revision: 471 $
*   $Date: 11/03/11 2:41p $
*
...
#define FOCUS_SEARCH_KF18               0x1D90        // Kf18 (RAM address 0x28)
...
#endif  //DDisc ==1
#define MIN_STM_FEpp_BD                 0
#define MIN_STM_FESRFO_RATIO_BD         0
...
#define FOCUS_CAPTURE_FSL_BD            65            // BD needs larger FSL to prevent focus on substrate?
#define FOCUS_CAPTURE_FSL_CD_DVD        65
...
#define FGA_PHASE_DVDROM                (14)
#define FGA_PHASE_DVDR                  (12)
#define FGA_PHASE_DVDRW                 (15)
#define FGA_PHASE_DVDRAM                (10 | HAL_SRV_FGAVS | HAL_SRV_FGASE)
#define FGA_PHASE_DVDROMDL              (14)
#define FGA_PHASE_DVDRDL                (14)
#define FGA_PHASE_DVDRWDL               (15)
...
#define FGA_PHASE_CDROM                 (12)
#define FGA_PHASE_CDR                   (12)
#define FGA_PHASE_CDRW                  (12)
...
#define TGA_PHASE_DVDRW                 (19)
#define TGA_PHASE_DVDRAM                (12 | HAL_SRV_TGAVS | HAL_SRV_TGASE)
#define TGA_PHASE_DVDROMDL              (19)
#define TGA_PHASE_DVDRDL                (13)
#define TGA_PHASE_DVDRWDL               (19)

// CD Tracking
#define TGA_FREQ_CD                     halSRV_AGC_2P75_KHZ  // Frequency of injected sinewave
...
#define FCS_VEL_FS_BD       {       0x1000    ,     0x1000      }
...
#endif
#define SLED_HOLD_GAIN                  30            //  30/128 =  23.4% for sledge to hold still
#define SLED_FOLLOW_GAIN                60            //  60/128 =  46.9% for following
#define SLED_JUMP_GAIN                  80            //  80/128 =  62.5%
#define SLED_FULL_GAIN                  128           // 128/128 = 100.0%
#define SLED_DZ                         0             // unit:sled output dac. To compansate drive IC dead zone, set 0 to disable this function.
...
#define MIN_SPEED_ENABLE_SRC_DVD  _6AX_DVD     // _6AX_DVD
#define MIN_SPEED_ENABLE_SRC_CD   _4LX         // _16AX,_10AX,_4LX
