...
*
*
* FILENAME:   svo_para_815.H
*
* DESCRIPTION: Servo Parameters for the SUN815 Project
*
*   $Revision: 83 $
*   $Date: 11/03/11 2:42p $
*
...
#define TRAY_IN_LEVEL1                  224//-224
#define TRAY_IN_LEVEL2                  317//-288
#define TRAY_IN_LEVEL3                  157//-224
...
//TRAY LEVEL (-512(pull) ~ 511(push))
#define TRAY_OUT_LEVEL1                 317//288
#define TRAY_OUT_LEVEL2                 112//224
...
#define NO_DISC_TH                      44.0          // acceleration RPM/mS
...
#define FOCUS_SEARCH_KF18               0x3349        // Kf18 (RAM address 0x28)
...
#endif
#define F_IDEN_DN_T_BD                  11            // Time to move lens down for disc detection.
#define F_IDEN_UP_T_BD                  92            // Time to move lens up for disc detection.
#define F_IDEN_DN_T_DVD                 84            // Time to move lens down for disc detection.
#define F_IDEN_UP_T_DVD                 135           // Time to move lens up for disc detection.
#define F_IDEN_DN_T_CD                  83            // Time to move lens down for disc detection.
#define F_IDEN_UP_T_CD                  148           // Time to move lens up for disc detection.
#define F_IDEN_SENSITIVITY_BD           (14706)       // unit:nm/dac
#define F_IDEN_SENSITIVITY_HD           (16304)       // unit:nm/dac
#define F_IDEN_SENSITIVITY_DVD          (16304)       // unit:nm/dac
#define F_IDEN_SENSITIVITY_CD           (17391)       // unit:nm/dac
...
#if DDisc ==1
#define DualDisc_STM_DVDLD_TH           740
#define DualDisc_STM_CDLD_TH            740
#define DualDisc_TE_P2P_TH              300
#define FESRFO_ratio_TH                 1.3
#endif  //DDisc ==1
#define MIN_STM_FEpp_BD                 800//org:250
#define MIN_STM_FESRFO_RATIO_BD         2.5//org:2.0
...
#define RATIO_TO_MAXFEPP                5             //improve FEpp measurement for BDR(E) DL

#define FE_FACTOR_BD_L0                 1.7
// Settings to compensate BD L1 measurement results because colli position is set to L0
#define FE_FACTOR_BD_L1                 2.1
#define BS_FACTOR_BD_L1                 1.7
...
#define FOCUS_CAPTURE_FSL_BD            50            // BD ramp up need larger FSL to prevent focusing on substrate
#define FOCUS_CAPTURE_FSL_CD_DVD        35
...
//-----------------------------------------------------------------------------;
#define DVDROM_TH                       0.45          // Threshold ratio to judge DVD R discs //adjust DVDROM_TH, DVDROMDL_TH
#define DVDROMDL_TH                     0.45          // Threshold ratio to judge DVD R DL discs //adjust DVDROM_TH, DVDROMDL_TH
#if (DETECT_CDR == 1)
#define CDROM_TH                        1.05          // If CDROM/R's MPPO/SRFO is more than this threshold, then judged as CDR
#endif
#define BDROM_TH                        1.80          // Threshold ratio to judge BD ROM discs
#define BDROMDL_TH                      2.00          // Threshold ratio to judge BD ROM DL discs
#define BD_WRONG_LAYER_TH               0.50          // Threshold ratio to judge BD wrong layer
#define BDRLTH_TH                       3.50          // 1.0 Threshold ratio to judge BDR LTH discs
...
#define TEBG_CAL_BEGIN_POINT            30            // Begin-point for TEBG calibration
...
#define TROOS_MPPSPPBG_FACTOR           8             // slope of TROOS vs MPP/SPPBG (larger safer)
#endif
...
#define Beall_SRFOpp_0dB_MinTH          180
#define Beall_SRFOpp_0dB_MaxTH          400
#define Beall_FEpp_0dB_MaxTH            620
#endif
...
#define BD_ECC100_TH                    110           // (um) Threshold ECC to judge as a BD ECC100 disc
#define BD_ECC150_TH                    150           // (um) Threshold ECC to judge as a BD ECC150 disc
#endif
...
#define FGA_PHASE_CDROM                 (8)
#define FGA_PHASE_CDR                   (8)
#define FGA_PHASE_CDRW                  (8)
...
#define FGA_PHASE_BDR                  (8)
#define FGA_PHASE_BDRE                 (8)
#define FGA_PHASE_BDROMDL              (6)
#define FGA_PHASE_BDRDL                (8)
#define FGA_PHASE_BDREDL               (8)
#endif
...
#define TGA_PHASE_DVDROM                (9)
#define TGA_PHASE_DVDR                  (10)
#define TGA_PHASE_DVDRW                 (10)
#define TGA_PHASE_DVDRAM                (13 | HAL_SRV_TGAVS | HAL_SRV_TGASE)
#define TGA_PHASE_DVDROMDL              (9)
#define TGA_PHASE_DVDRDL                (10)
...
#define TGA_PHASE_CDROM                 (9)
#define TGA_PHASE_CDR                   (9)
#define TGA_PHASE_CDRW                  (9)
...
#define TGA_PHASE_BDROM                (3)
#define TGA_PHASE_BDR                  (5)
#define TGA_PHASE_BDRE                 (5)
#define TGA_PHASE_BDROMDL              (3)
#define TGA_PHASE_BDRDL                (5)
#define TGA_PHASE_BDREDL               (5)
#endif
...
#define ROUGH_THRESHOLD_BD              UM_2_SLED_STEP(300)
...
#define FCS_VEL_FS_UNKNOWN  {       0x0600    ,     0x0500      }
#define FCS_VEL_FS_CD       {       0x0600    ,     0x0500      }
#define FCS_VEL_FS_DVD      {       0x0600    ,     0x0500      }
#define FCS_VEL_FS_LS       {       0x0600    ,     0x0500      }
#define FCS_VEL_FS_BD       {       0x0800    ,     0x0A00      }
#define FCS_VEL_FS_HD       {       0x0600    ,     0x0500      }

// Settings for Layer Jump
#define FCS_VEL_LJ_UNKNOWN  {       0x0600    ,     0x0500      }
#define FCS_VEL_LJ_CD       {       0x0600    ,     0x0500      }
#define FCS_VEL_LJ_DVD      {       0x0600    ,     0x0500      }
#define FCS_VEL_LJ_LS       {       0x0600    ,     0x0500      }
#define FCS_VEL_LJ_BD       {       0x0600    ,     0x0500      }
#define FCS_VEL_LJ_HD       {       0x0600    ,     0x0500      }
...
//-----------------------------------------------------------------------------;
//128=100%
#define TRACKING_GAINUP_FACTOR_CD       140
#if (SUPPORT_DPD == 1)
#define TRACKING_FACTOR_CD_DPD          272//255
#endif
#if (CD_MB_ONLY_OPU == 1)
...
#endif //OPU_HomeSW
#define HOMING_DISTANCE                 (66*MICRO_STEP_PER_ELE_REV+((STEP_OUTWARD_POSITION-STEP_HOME_POSITION_INIT)&0x7F))
...
#define STEP_OUTWARD_POSITION           12766
...
#define COLLI_HOMING_POST_DISTANCE      256
    #else
#define COLLI_HOMING_PRE_DISTANCE       320
#define COLLI_HOMING_POST_DISTANCE      320
    #endif
#define COLLI_HOMING_DISTANCE           14720          //OPU                            :SFBD412// set colli maximum range
...
#if (OPU_HomeSW == 0)
#define SLED_HOMING_GAIN                25            // 25 /128 =  19.5% for sledge to hit the wall
#endif
#define SLED_HOLD_GAIN                  10            // 20 /128 =  15.6% for sledge to hold still
#define SLED_FOLLOW_GAIN                40            // 60 /128 =  46.9% for following
#define SLED_JUMP_GAIN                  48            // 68 /128 =  53.1%
#define SLED_FULL_GAIN                  64            // 64 /128 =  50.0%
#define SLED_DZ                         40            // unit:sled output dac. To compansate drive IC dead zone, set 0 to disable this function.
...
#define SLED_HOME_JUMP_PROFILE          { 37,   13,   13,   12,  SLED_JUMP_GAIN} /* STEP_HOMING_PROFILE */ //this mode the SLED_GAIN will be smoothly reduced to SLED_HOMING_GAIN during jump
#define SLED_FULL_JUMP_PROFILE          { 15,    9,    9,   10,  SLED_FULL_GAIN} /* STEP_FULL_PROFILE */   //this mode use higher gain to pull OPU away from the wall
#define SLED_SAFE_JUMP_PROFILE          { 36,   12,   17,   24,  SLED_JUMP_GAIN} /* STEP_SAFE_SLOW_PROFILE */
...
#define SLED_NO_CE_JUMP_PROFILE         {  3,    1,    1,  255,  SLED_JUMP_GAIN} /* STEP_NO_CE_SLOW_PROFILE */
/* collimator jump profile                  VMax,  Acc,  Dec,VFull,  Gain  */
#if COLLI_SWITCH == 1
#define COLLI_NORMAL_JUMP_PROFILE       { 48,   40,   40,    0,  COLLI_JUMP_GAIN}/* COLLI_NORMAL_PROFILE*/
#define COLLI_MICRO_JUMP_PROFILE        { 13,    1,    1,    0,  COLLI_JUMP_GAIN}/* COLLI_MICRO_PROFILE*/
#endif
...
#define COLLI_REST_TIME             100     //a rest time between 2 long colli jump to guarantee the driving duty is within spec
...
#define SLED_JUMP_MIN_VEL   3  //minimum velocity for sledge jump. unit:step / ms
...
#define CE_GAIN_DOWN_RATIO_BD           84      // (84/128) CE gain-down ratio
...
#define TRACK_SLIP_DETECT_THRESHOLD     UM_2_SLED_STEP(380)     /* The threshold of TEINT that defines track slipping!! */
...
#define MIN_SPEED_ENABLE_SRC_DVD     _2LX_DVD
#define MIN_SPEED_ENABLE_SRC_DVDRAM  _16AX_DVDRAM
#define MIN_SPEED_ENABLE_SRC_CD      _16AX
...
#define PDIC_GAIN_CD             -50,     38
#define PDIC_GAIN_DVD            -50,     36
#define PDIC_GAIN_BD             -93,      0

#define PDIC_GAIN_MAX_CD           2
#define PDIC_GAIN_MAX_DVD          2
...
#define PDIC_SRFO_TARGET_CD        450
#define PDIC_SRFO_TARGET_DVD       450
#define PDIC_SRFO_TARGET_BD        400
#else
// OPU Gain (0.1dB)               0,    1,    2,    3,    4,    5,    6,    7,
#define OPU_GAIN                -50, NULL,  -50,   38,   36,  -93,  -16,    0

// OPU Gain Select                mode
#define OPU_GAIN_SELECT_CDR       2             //CDROM/R
#define OPU_GAIN_SELECT_CDRW      3             //CDRW
#define OPU_GAIN_SELECT_DVDR      0             //DVDROM/+R/-R SL
#define OPU_GAIN_SELECT_DVDRDL    4             //DVDROM/+R/-R DL
#define OPU_GAIN_SELECT_DVDRW     4             //DVD+RW/-RW SL
#define OPU_GAIN_SELECT_DVDRWDL   4             //DVD+RW/-RW DL
#define OPU_GAIN_SELECT_DVDRAM    4             //DVDRAM
#define OPU_GAIN_SELECT_BD_RO_SL  5             //BDROM SL
#define OPU_GAIN_SELECT_BD_RO_DL  5             //BDROM DL
#define OPU_GAIN_SELECT_BD_RE_SL  7             //BDR/RE SL
#define OPU_GAIN_SELECT_BD_RE_DL  7             //BDR/RE DL
#endif
...
//-----------------------------------------------------------------------------;
#define FOC_DRIVER_GAIN                     2.65    // dependent on PCB
#define TRK_DRIVER_GAIN                     2.48    // dependent on PCB
#define FOC_ACT_R                           6000    // dependent on OPU; unit in m ohm from OPU spec
#define TRK_ACT_R                           5000    // dependent on OPU; unit in m ohm from OPU spec
...
#define PWR_FOC                             240    //unit:mW from OPU spec Plimit=IIR
#define PWR_TRK                             200    //unit:mW from OPU spec
#define ACTDISS_TAU                         3000   // unit:ms from OPU spec
#endif
//--------------------------------------------------------------------------------------------------------------------;
// Supported HD speed                                                                                                ;
//--------------------------------------------------------------------------------------------------------------------;
